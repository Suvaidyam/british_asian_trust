<template>
  <div class="min-h-screen bg-white">
      ...
      <div class="max-w-[1512px] mx-auto">
        ...
        <div class="md:flex md:space-x-8">
          ...
          <div class="md:w-1/2 relative mt-8 md:mt-0 max-w-[1512px] mx-auto">
            ...
            <button
              class="absolute top-[-20px] sm:top-[-25px] md:top-[-30px] right-4 sm:right-[-50px] md:right-[-80px] lg:right-[-110px] transform -translate-x-1/2 bg-[#06A0A0] text-white py-2 px-4 sm:py-3 sm:px-6 md:px-8 lg:px-36 rounded-lg transition duration-300 font-poppins text-xl sm:text-2xl md:text-3xl font-normal leading-tight sm:leading-[40px] md:leading-[50.4px] text-center h-[50px] sm:h-[60px] md:h-[65px]">
              How It Works
            </button>
          </div>
        </div>
    ...
    <section class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div class="max-w-[1512px] mx-auto relative">
        <div class="space-y-4 h-[587px] w-[1060px] bg-white border-gray-[#DBDBDB] rounded-lg p-5 border mx-auto">
          <h2
