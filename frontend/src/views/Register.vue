          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            <div>
              ...
              <input type="text" id="full-name" v-model="fullName" @input="validateField('fullName')"
                class="w-full px-4 h-12 border border-gray-300 rounded-md font-poppins text-[16px] font-normal leading-[20.96px] tracking-[0.0025em] text-[#2F2F2F] focus:outline-none focus:ring-2 focus:ring-[#0D4688] focus:border-[#0D4688]" placeholder="Full Name">
            ...
            <div>
              ...
              <input type="email" id="email" v-model="email" @input="validateField('email')"
                class="w-full px-4 h-12 border border-gray-300 rounded-md font-poppins text-[16px] font-normal leading-[20.96px] tracking-[0.0025em] text-[#2F2F2F] focus:outline-none focus:ring-2 focus:ring-[#0D4688] focus:border-[#0D4688]" placeholder="Email Address">
