<template>
  <div class=" w-full max-w-[1512px] mx-auto relative">
    ...
    <div class="flex justify-center min-h-screen bg-gray-100 p-4 sm:p-0">
      <div class="w-full max-w-[1512px] flex flex-col lg:flex-row shadow-xl">
        <!-- Image Section -->
          ...
          <div class="w-full max-w-lg">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-4">
              ...
              <div>
                ...
                <p class="text-gray-600 text-xs mt-1 font-poppins">Use only your work email for registration. Personal
                  emails are not allowed.</p>
              </div>
              ...
              <p v-if="errors.termsAccepted" class="text-red-500 text-xs mt-1 font-poppins">{{ errors.termsAccepted }}
              </p>
            ...
            <div class="mt-6 flex items-center">
              ...
              <span
                class="flex-shrink mx-4 text-gray-600 font-poppins text-[16px] font-normal leading-[20.96px] tracking-[0.0025em]">OR</span>
              <div class="flex-grow border-t border-gray-300"></div>
            </div>
