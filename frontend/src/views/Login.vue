		...
		<div class="w-full max-w-[1512px] flex flex-col lg:flex-row shadow-2xl">
			...
			<div class="lg:w-1/2 p-4 sm:p-8 flex flex-col justify-center items-center bg-white">
				<div class="w-full max-w-lg">
					...
					<p
						class="font-poppins text-[14px] font-normal leading-[18.34px] tracking-[0.0025em] text-[#2F2F2F] lg:text-[14px] lg:leading-[18.34px] mb-6 sm:mb-8 text-center">
						Login to empower your organization and gain access to surveys, personalized recommendations, and
						tools to drive impact.
					</p>
					<form @submit.prevent="handleSubmit" class="space-y-4">
						<div>
							<label for="email" class="sr-only">Email ID</label>
							<input id="email" v-model="email" type="email" required
								class="w-full px-4 h-12 border border-gray-300 rounded-md font-poppins text-[16px] font-normal leading-[20.96px] tracking-[0.0025em] text-left text-[#2F2F2F]"
						...
						<div class="relative">
							...
							<p v-if="errors.password" class="text-red-500 text-xs sm:text-sm mt-1">{{ errors.password }}
							</p>
						</div>
					...
					<div class="mt-6 flex items-center">
						...
						<span
							class="flex-shrink mx-4 text-gray-600 font-poppins text-[16px] font-normal leading-[20.96px] tracking-[0.0025em] text-left">OR</span>
						<div class="flex-grow border-t border-gray-300"></div>
					</div>
					<div class="mt-6 space-y-2">
						<a :href="googleAuthUrl"
							class="w-full border border-gray-300 text-gray-700 h-12 px-4 rounded-full
				hover:bg-gray-50 transition duration-300 flex items-center justify-center font-poppins text-[16px] font-normal leading-[20.96px] tracking-[0.0025em] text-left">
						...
						<a :href="microsoftAuthUrl"
							class="w-full border border-gray-300 text-gray-700 h-12 px-4 rounded-full hover:bg-gray-50
				transition duration-300 flex items-center justify-center font-poppins text-[16px] font-normal leading-[20.96px] tracking-[0.0025em] text-left">
