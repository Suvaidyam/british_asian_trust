  ...
  <div class="min-h-screen bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      ...
      <div class="flex flex-col lg:flex-row gap-6">
        ...
        <!-- Users Section -->
        <div class="w-full lg:w-1/4 bg-main-user rounded-lg p-4 shadow-md ">
          ...
          <div class="flex flex-col items-center mb-6 pt-4">
            <div class="relative">
              ...
              <span v-if="users[0].isCrowned"
                class="absolute top-[-15px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-yellow-400 text-4xl">👑</span>
            </div>
          ...
          <div class="flex justify-around mb-6">
            <div v-for="user in users.slice(1, 3)" :key="user.id" class="text-center">
              <img :src="users.image" :alt="user.name" class="w-16 h-16 rounded-full mx-auto shadow-sm" />
