<template>
  <div class="relative">
      ...
      <div class="max-w-[2048px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          ...
          <div class="hidden md:flex items-center space-x-4">
            <button @click="toggleNavigation" class="text-gray-600 hover:text-gray-800 focus:outline-none">
    ...
    <!-- Notification Slider -->
    <NotificationSlider :is-open="isNotificationSliderOpen" :notifications="notifications" @close="closeNotificationSlider" />
  </div>
</template>
