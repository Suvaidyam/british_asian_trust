            ...
            <div class="flex items-center justify-between h-[60px]">
                <div class="flex items-center justify-between">
                    <div class="flex-shrink-0">
                        <img class="h-7 w-auto" src="../assets/logo.png" alt="Logo">
                    </div>
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <div v-if="$auth.isLoggedIn" class="ml-auto">
                            <div class="flex items-baseline space-x-4">
                                ...
                                <a href="/assessment"
                                    class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Assessments</a>
                                <a href="/myuser"
                            ...
                            <div class="ml-3 relative ">
                                <div class="flex items-center justify-center gap-3">
                                    <button @click="toggleDropdown" type="button"
                                        ...
                                        <img class="h-8 w-8 rounded-full" src="../assets/main_bg.png" alt="User avatar">
                                    </button>
                                    <p>{{ $auth?.cookie?.full_name }}</p>
        ...
        <transition enter-active-class="transition ease-out duration-100"
            ...
            <div v-if="isMobileMenuOpen" class="md:hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <a href="/assessment"
                        class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Assessments</a>
                    <a href="/myuser"
                ...
                <div class="pt-4 pb-3 border-t border-gray-700">
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            <img class="h-10 w-10 rounded-full" src="../assets/main_bg.png" alt="User avatar">
                        </div>
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">{{ $auth?.cookie?.full_name }}
                            </div>
